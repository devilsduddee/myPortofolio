            ...
            <div className="mt-auto pt-4 flex items-center gap-2 border-t border-white/10">
              {project.demo_url && (
                <a 
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-white/10 text-white text-[13px] font-semibold rounded-lg border border-white/20 hover:bg-white/20 hover:text-blue-400 hover:border-blue-400/50 transition-all shadow-sm shadow-black/20"
                >
              ...
              {project.repository_url && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-white/5 text-slate-300 text-[13px] font-semibold rounded-lg border border-white/10 hover:bg-white/10 hover:text-white transition-all shadow-sm shadow-black/20"
                >
                  <Github size={14} />
                  Repo
                </a>
