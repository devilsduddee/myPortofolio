...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <>
      {/* Project Card */}
      <div className="h-full group brutal-card-hover bg-neo-surface border-4 border-neo-border shadow-brutal rounded-[20px] overflow-hidden flex flex-col justify-between">
      ...
      {/* Neo Brutalist Popup Modal for Full Details */}
      <AnimatePresence>
        {isModalOpen && (
