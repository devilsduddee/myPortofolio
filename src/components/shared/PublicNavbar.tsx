      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-[80px] bg-neo-surface border-b-4 border-neo-border flex items-center px-4 sm:px-8 md:px-12 justify-between">
        ...
        <div className="hidden md:flex items-center">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4.5 py-2.5 text-xs font-black uppercase tracking-wider bg-neo-blue text-white border-3 border-neo-border rounded-xl shadow-brutal-sm hover:-translate-y-0.5 hover:bg-blue-700 active:scale-[0.97] active:translate-y-0 focus-visible:ring-4 focus-visible:ring-neo-border focus-visible:outline-none transition-transform"
          >
